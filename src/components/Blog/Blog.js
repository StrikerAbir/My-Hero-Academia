    ...
    <div className=" flex flex-col items-center py-10">
      ...
      <div className="text-center w-3/4">
        ...
        <p>
          ...
          with the URL. React Router, and dynamic, client-side routing, allows
          us to build a single-page web application with navigation without the
          page refreshing as the user navigates.
        </p>
        <h2 className="text-xl lg:text-2xl font-bold text-[#e92b19] my-3 shadow-md rounded border-x-4 border-[#e92b19] border-t p-3">
        ...
        <p>
          ...
          initialValue useRef(initialValue). The object can persist a value for
